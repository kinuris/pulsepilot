<nav wire:ignore.self class="flex flex-col bg-white shadow-xl min-w-[280px] max-w-[280px] h-screen border-r border-gray-100">
    ...
    <div class="flex flex-col space-y-1 py-4">
        ...
        <a wire:navigate href="{{ route('settings') }}">
            <div class="{{ request()->routeIs('settings') ? 'bg-blue-50 text-blue-700 border-r-4 border-blue-600' : 'text-gray-700 hover:bg-gray-50' }} nav-item flex items-center space-x-3 px-6 py-3 transition-all duration-200">
                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
